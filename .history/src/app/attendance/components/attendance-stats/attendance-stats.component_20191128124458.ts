    ...
    this.LineChart = new Chart('lineChartMonthly', {
      ...
      data: {
        ...
        datasets: [
          {
            // tslint:disable-next-line:max-line-length
            data: [45, 46, 76 , 83, 15, 41, 25, 53 , 86, 77, 45, 41, 48, 83, 65, 45, 46, 76 , 83, 15, 41, 25, 53 , 86, 77, 45, 41, 48, 83, 65],
            label: 'Present',
            borderColor: '#8e5ea2',
            fill: false,
      ...
      options: {
        ...
        tooltips: {
          ...
          callbacks: {
              ...
              label: function(tooltipItem, data) {
                  const multiline = ['First Line', 'second line'];
                  return multiline;
              },
          ...
          custom: function(tooltip) {
              ...
              const innerHtml = '<div class="arrow" style="left: '+tooltip.caretX+'px;"></div>'
                  + '<div class="tooltip-inner" style="max-width: none;">' + tooltip.body[0].join('<br>')
                  + '</div>';
              tooltipEl.html( innerHtml );
              tooltipEl.css( {
                  opacity: 1,
                  left: $('#lineChartMonthly').offset().left + tooltip.x + 'px',
                  top: $('#lineChartMonthly').offset().top + tooltip.y + 'px'
              } );
