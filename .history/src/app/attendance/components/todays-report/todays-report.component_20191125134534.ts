...
export class TodaysReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // console.log(endTime);
    this.apiService.getPresentEmployeesForDate({'start_time': 1574188200000, 'end_time': 1574314498000, 'token' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywiYXdpcm9zIjoiYXdpcm9zdGVjaEBnbWFpbC5jb20iLCJsZXZlbCI6ImF3aV9hZG1pbiIsImlhdCI6MTU3NDY2NjU2OCwiZXhwIjoxNTc0NzUyOTY4fQ.F4OH36qkGpIU5EQMc5ES0g_SOQ44Pv-fZk7w4EBWw30' })
