...
export class SidebarComponent implements OnInit {
    ...
    severityOption: string[] = ['critical', 'high',  'medium' , 'low'];

    subClass: FormControl;
    label: FormControl;
    severity: FormControl;
    awi_class: FormControl;
    ...
    createFormControls() {
        ...
        this.awi_class = new FormControl('awi_face');
    }
...
//   }
  ...
  onSubmit() {
     ...
     if (this.registerForm.valid) {
        ...
        formData.append('awi_class', this.registerForm.get('awi_class').value);
